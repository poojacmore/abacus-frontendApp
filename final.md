...
const routes: Routes = [
  ...
  { path: 'functionapplications', component: ListTodosComponent, canActivate: [RouteGuardService] },
  { path: 'logout', component: LogoutComponent, canActivate: [RouteGuardService] },
  { path: 'functionapplications/:id', component: TodoComponent, canActivate: [RouteGuardService] },
...
export class AppComponent {
  title = 'todo';
  message = 'Welcome to Abakus 2021';
}
```
  ...
  <table class="table">
    ...
    <tbody>
      ...
      <tr *ngFor="let todo of todos">
        ...
        <td>
          <button (click)="deleteTodo(todo.id)" class="btn btn-warning">
            Delete
          </button>
        </td>
      </tr>
...
<div class="container">
  ...
  <div>
    ...
    <button (click)="handleAWSCognitoLogin()" class="btn btn-success">
      Login
    </button>
  </div>
</div>
...
<header>
  <nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div>
      <a href="https://www.in28minutes.com" class="navbar-brand">
        in28minutes</a
      >
    </div>
    ...
    <ul class="navbar-nav">
      <li>
        <a
          *ngIf="isUserLoggedIn"
          routerLink="/welcome/in28minutes"
          class="nav-link"
          >Home</a
        >
      </li>
      <li>
        <a *ngIf="isUserLoggedIn" routerLink="/todos" class="nav-link">Todos</a>
      </li>
    </ul>

    <ul class="navbar-nav navbar-collapse justify-content-end">
      <li>
        <a *ngIf="!isUserLoggedIn" routerLink="/login" class="nav-link"
          >Login</a
        >
      </li>
      <li>
        <a *ngIf="isUserLoggedIn" routerLink="/logout" class="nav-link"
          >Logout</a
        >
      </li>
    </ul>
...
<div class="container">
  ...
  <button (click)="getWelcomeMessageWithParameter()" class="btn btn-success">
    Get Welcome Message
  </button>
</div>
